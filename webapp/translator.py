...
def html_parser(html_filename, newfilename, og_name, to_lang, from_lang ):
    ...
    for current_page_no, page in enumerate(pages, start=1):
        ...
        # print(f"\rTranslated({current_page_no},{total_no_pages})", end='', flush=True)
